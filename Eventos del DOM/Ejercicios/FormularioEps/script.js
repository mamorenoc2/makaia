document.addEventListener('DOMContentLoaded', function() {
    ...
    const capturarDatos = () => {
      ...
      formulario.addEventListener('submit', (event) => {
        ...
        capturarDatos(); // Esto parece estar mal ubicado, revisa su ubicación
  
        // No necesitas llamar a capturarDatos() aquí, ya que ya lo llamaste
        // dentro del evento submit anteriormente.
      });
    };
  
    capturarDatos(); // Llamada inicial a capturarDatos para cargar los datos guardados en localStorage
  });
